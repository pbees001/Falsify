...
var SekindoClientDetections_URL = function (config) {
	...
	this.setInfo();
				...
				var urlDetObj = new SekindoClientDetections_URL({
					url: 'https://live.primis.tech/live/liveView.php?s=107717&cbuster=1634451532',
					origQString: 's=107717',
					placementId: 107717,
					x: 300,
					y: 250,
					videoType: 'sticky',
